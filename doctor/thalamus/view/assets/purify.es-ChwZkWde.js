...
var g = w(Array.prototype.forEach),
  te = w(Array.prototype.lastIndexOf),
  ne = w(Array.prototype.pop),
...
var he = d(
  ...
  M = function (e, t, n, r) {
    return b(e, t) && _(e[t])
      ? E(r.base ? O(r.base) : {}, e[t], r.transform)
      : n;
  },
  Ge = function (e, t, n) {
...
function Ke() {
  ...
  let u = e.DOMParser,
    ...
    j = s && s.prototype ? k(s.prototype, `ownerDocument`) : null,
    qe = function (e) {
  ...
  let N,
    ...
    tt = n,
    nt = tt.implementation,
    rt = tt.createNodeIterator,
    it = tt.createDocumentFragment,
    at = tt.getElementsByTagName,
    ot = r.importNode,
    I = We();
  t.isSupported =
    typeof o == `function` &&
  ...
  let st = Ee,
    ...
    It = null,
    Lt = E({}, [`audio`, `video`, `img`, `source`, `image`, `track`]),
    Rt = null,
    zt = E({}, [
      `alt`,
      `class`,
    ...
    Ut = null,
    Wt = E({}, [Bt, Vt, q], oe),
    Gt = d([`mi`, `mo`, `mn`, `ms`, `mtext`]),
    Kt = E({}, Gt),
    qt = d([`annotation-xml`]),
    Jt = E({}, qt),
    Yt = E({}, [`title`, `style`, `font`, `a`, `script`]),
    Xt = null,
    ...
    en = function () {
      ...
      ((!e || typeof e != `object`) && (e = {}),
        ...
        (Xt =
          Zt.indexOf(e.PARSER_MEDIA_TYPE) === -1
            ? `text/html`
            : e.PARSER_MEDIA_TYPE),
        (Y = Xt === `application/xhtml+xml` ? oe : ae),
        (L = M(e, `ALLOWED_TAGS`, gt, { transform: Y })),
        (R = M(e, `ALLOWED_ATTR`, _t, { transform: Y })),
        (Ut = M(e, `ALLOWED_NAMESPACES`, Wt, { transform: oe })),
        (Rt = M(e, `ADD_URI_SAFE_ATTR`, zt, { transform: Y, base: zt })),
        (It = M(e, `ADD_DATA_URI_TAGS`, Lt, { transform: Y, base: Lt })),
        (K = M(e, `FORBID_CONTENTS`, Ft, { transform: Y })),
        (vt = M(e, `FORBID_TAGS`, O({}), { transform: Y })),
        (yt = M(e, `FORBID_ATTR`, O({}), { transform: Y })),
        (G = b(e, `USE_PROFILES`)
          ? e.USE_PROFILES && typeof e.USE_PROFILES == `object`
            ? O(e.USE_PROFILES)
            : e.USE_PROFILES
          : !1),
        (bt = e.ALLOW_ARIA_ATTR !== !1),
        (xt = e.ALLOW_DATA_ATTR !== !1),
        (St = e.ALLOW_UNKNOWN_PROTOCOLS || !1),
        (Ct = e.ALLOW_SELF_CLOSE_IN_ATTR !== !1),
        ...
        (Nt = e.KEEP_CONTENT !== !1),
        (Pt = e.IN_PLACE || !1),
        (ht = me(e.ALLOWED_URI_REGEXP) ? e.ALLOWED_URI_REGEXP : je),
        (J = typeof e.NAMESPACE == `string` ? e.NAMESPACE : q),
        (Kt = Ge(e, `MATHML_TEXT_INTEGRATION_POINTS`, () => E({}, Gt))),
        (Jt = Ge(e, `HTML_INTEGRATION_POINTS`, () => E({}, qt))));
      ...
      if (
        ...
        G &&
          ((L = E({}, xe)),
          (R = p(null)),
          G.html === !0 && (E(L, he), E(R, Se)),
          G.svg === !0 && (E(L, ge), E(R, Ce), E(R, Te)),
          G.svgFilters === !0 && (E(L, _e), E(R, Ce), E(R, Te)),
          G.mathMl === !0 && (E(L, ye), E(R, we), E(R, Te))),
        (B.tagCheck = null),
        (B.attributeCheck = null),
        b(e, `ADD_TAGS`) &&
          (typeof e.ADD_TAGS == `function`
            ? (B.tagCheck = e.ADD_TAGS)
            : _(e.ADD_TAGS) && (L === gt && (L = O(L)), E(L, e.ADD_TAGS, Y))),
        b(e, `ADD_ATTR`) &&
          (typeof e.ADD_ATTR == `function`
            ? (B.attributeCheck = e.ADD_ATTR)
            : _(e.ADD_ATTR) && (R === _t && (R = O(R)), E(R, e.ADD_ATTR, Y))),
        b(e, `ADD_FORBID_CONTENTS`) &&
          _(e.ADD_FORBID_CONTENTS) &&
          (K === Ft && (K = O(K)), E(K, e.ADD_FORBID_CONTENTS, Y)),
        Nt && (L[`#text`] = !0),
        U && E(L, [`html`, `head`, `body`]),
        L.table && (E(L, [`tbody`]), delete vt.tbody),
    ...
    on = function (e, t, n) {
      return (t.namespaceURI === Vt && !Jt[n]) ||
        (t.namespaceURI === Bt && !Kt[n])
        ? !1
        : !nn[e] && (Yt[e] || !tn[e]);
    },
    sn = function (e) {
      ...
      return Ut[e.namespaceURI]
        ? e.namespaceURI === Vt
          ...
          : e.namespaceURI === Bt
            ...
            : e.namespaceURI === q
              ? on(n, t, r)
              : !!(Xt === `application/xhtml+xml` && Ut[e.namespaceURI])
        : !1;
    },
    Z = function (e) {
    ...
    Q = function (e, n, r) {
      ...
      re(t.removed, { attribute: r || null, from: n });
      try {
    ...
    fn = function (e, t) {
      return H
        ? e === `patchsrc` || (e === `for` && t !== `label` && t !== `output`)
        : !1;
    },
    pn = function (e) {
      if (!H) return;
    ...
    mn = function (e) {
      ...
      return (
        ...
        J === q ? at.call(t, U ? `html` : `body`)[0] : U ? t.documentElement : a
      );
    },
    hn = function (e) {
  ...
  let xn = function (e, t) {
      return !!(
        ...
        (H &&
          ...
          Be[t] &&
          (bn(e.firstElementChild) ||
            (typeof e.textContent == `string` && S(Ve[t], e.textContent)))) ||
        e.nodeType === A.processingInstruction ||
        (H && e.nodeType === A.comment && S(Le, e.data))
      );
    },
    Sn = function (e, t) {
      return e instanceof RegExp
        ? S(e, t)
        : e instanceof Function && !!e(t, ...[...arguments].slice(2));
    },
    Cn = function (e, t, n) {
    ...
    En = function (e, n) {
      ...
      let r = Y(Je(e));
      if (
        ((L = wn(I.uponSanitizeElement, L, gt, Tt)),
      ...
      if (V && e.nodeType === A.text) {
        ...
        e.textContent !== n &&
          (re(t.removed, { element: e.cloneNode() }), (e.textContent = n));
      }
      ...
      for (; t.length > 0; ) {
        ...
        if (r) {
          ...
          if (typeof e == `string` && Y(e) === `template`) {
            let e = n.content;
            yn(e) && t.push({ node: e, shadow: null });
          }
        }
        if (r) {
          let e = x(n);
          yn(e) && t.push({ node: null, shadow: e }, { node: e, shadow: null });
        }
      }
    };
  return (
    (t.sanitize = function (e) {
      ...
      if (
        ((Ht = !e),
        Ht && (e = `<!-->`),
        typeof e != `string` && !bn(e) && ((e = pe(e)), typeof e != `string`))
      )
      ...
      (wt ? ((L = Tt), (R = Et)) : en(n),
        (I.uponSanitizeElement.length > 0 ||
          ...
          (L = O(L)),
        I.uponSanitizeAttribute.length > 0 && (R = O(R)),
        (t.removed = []));
      ...
      if (c) {
        ...
        if (vn(e))
          throw (
            ln(e),
            C(`root node is clobbered and cannot be sanitized in-place`)
          );
        try {
          Pn(e);
        } catch (t) {
        ...
        ((i = mn(`<!---->`)),
          ...
          (a.nodeType === A.element && a.nodeName === `BODY`) ||
          a.nodeName === `HTML`
            ? (i = a)
            : i.appendChild(a),
          Pn(a));
      ...
      try {
        let e = hn(l);
        for (; (o = e.nextNode()); )
          (En(o, l), Mn(o), yn(o.content) && Nn(o.content));
      } catch (n) {
        throw (
          c &&
            (ln(e),
      ...
      if (W) {
        if ((V && _n(i), Ot))
          for (s = it.call(i.ownerDocument); i.firstChild; )
            s.appendChild(i.firstChild);
        else s = i;
        return (
          (R.shadowroot || R.shadowrootmode) && (s = ot.call(r, s, !0)),
          s
        );
      }
...
//# sourceMappingURL=purify.es-ChwZkWde.js.map
